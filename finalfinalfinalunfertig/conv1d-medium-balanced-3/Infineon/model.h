...
// Model GUID (16 bytes)
#define IMAI_MODEL_ID {0x88, 0x75, 0x0c, 0xe7, 0xb8, 0x73, 0xc8, 0x42, 0xb2, 0x76, 0xa6, 0xdb, 0x09, 0x77, 0xe9, 0x2d}
...
#define IMAI_DATA_OUT_SYMBOLS {"unlabeled", "east", "north", "west", "northeast", "northwest"}
