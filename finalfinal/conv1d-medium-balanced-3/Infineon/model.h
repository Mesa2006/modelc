...
// Model GUID (16 bytes)
#define IMAI_MODEL_ID {0x38, 0x4b, 0x00, 0x8b, 0xd7, 0x24, 0xa3, 0x42, 0xa6, 0xbf, 0x54, 0x4f, 0x31, 0x6f, 0x37, 0x33}
...
#define IMAI_DATA_OUT_SYMBOLS {"unlabeled", "east", "north", "west"}
